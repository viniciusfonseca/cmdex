...
pub(in crate::app) fn draw_git_diff(frame: &mut Frame, app: &App, area: Rect) {
...
pub(in crate::app) fn git_diff_layout(area: Rect) -> GitDiffLayout {
...
pub(in crate::app) fn git_diff_section_from_click(
    area: Rect,
    changes_label: &str,
    staged_label: &str,
    column: u16,
...
pub(in crate::app) fn git_diff_remote_button_label(
    label: &str,
...
impl App {
    pub(in crate::app) fn handle_git_diff_sidebar_click(
        &mut self,
        column: u16,
        row: u16,
        sidebar_list: Rect,
    ...
    pub(in crate::app) fn handle_git_diff_key(
        &mut self,
        key: KeyEvent,
    ...
    pub(in crate::app) fn handle_git_diff_click(
        &mut self,
        column: u16,
        row: u16,
        area: Rect,
